...
export const AdminHeader = () => {
    ...
    return (
        <header className="sticky top-0 z-40 h-[64px] bg-white dark:bg-zinc-950 border-b border-zinc-200 dark:border-white/5 px-8 flex items-center justify-between">
            {/* Left: Search */}
            <div className="flex items-center gap-4 flex-1 max-w-xl">
                <div className="relative w-full max-w-md group">
                    ...
                    <input
                        type="search"
                        placeholder="Search songs, albums, users... (⌘K)"
                    ...
                    />
                    <kbd className="absolute right-3 top-1/2 -translate-y-1/2 hidden sm:inline-flex h-5 items-center gap-1 rounded border border-zinc-200 dark:border-white/10 bg-zinc-50 dark:bg-white/5 px-1.5 font-mono text-[10px] font-medium text-zinc-500">
