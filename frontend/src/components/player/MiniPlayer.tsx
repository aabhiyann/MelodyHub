        ...
        >
            <div className="bg-bg-secondary border-t border-white/10 backdrop-blur-xl">
                <div className="flex items-center gap-4 px-4 py-3">
                    <button onClick={() => {}} className="flex items-center gap-3 flex-1 min-w-0 hover:bg-white/5 p-2 -m-2 rounded-lg transition-colors">
                        <img src={currentSong.imageUrl} alt={currentSong.title} className="size-12 rounded object-cover shrink-0" />
