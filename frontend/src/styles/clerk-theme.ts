...
export const clerkTheme: Appearance = {
  variables: {
    ...
    colorText: '#ffffff',
    colorTextSecondary: '#d4d4d8', // zinc-300 (lighter for better readability)
  ...
  elements: {
    ...
    headerSubtitle: 'text-zinc-300 text-base', // Lighter for readability
    ...
    formFieldLabel: 'text-zinc-200 font-semibold text-sm', // Higher contrast
    ...
    userButtonPopoverFooter: 'bg-zinc-900/50',
  },
