...
const GamificationPage = () => {
    ...
    return (
        <div className="h-full flex flex-col">
            <Topbar />
            <div className="flex-1 flex flex-col p-6 space-y-6 pb-32 md:pb-6">
            {/* Header / Hero Section */}
            ...
            <Tabs defaultValue="quests" className="flex-1 flex flex-col min-h-0">
                <TabsList className="bg-zinc-900/50 p-1 w-full flex overflow-x-auto rounded-xl">
                    <TabsTrigger value="quests" className="flex-1 min-h-[44px] rounded-lg data-[state=active]:bg-emerald-600 data-[state=active]:text-white data-[state=active]:border-transparent transition-all">
                        <Target className="mr-2 size-4" />
                        Quests
                    </TabsTrigger>
                    <TabsTrigger value="leaderboard" className="flex-1 min-h-[44px] rounded-lg data-[state=active]:bg-emerald-600 data-[state=active]:text-white data-[state=active]:border-transparent transition-all">
                        <Trophy className="mr-2 size-4" />
                        Leaderboard
                    </TabsTrigger>
                    <TabsTrigger value="achievements" className="flex-1 min-h-[44px] rounded-lg data-[state=active]:bg-emerald-600 data-[state=active]:text-white data-[state=active]:border-transparent transition-all">
                        <Medal className="mr-2 size-4" />
                        Achievements
                    </TabsTrigger>
                    <TabsTrigger value="shop" className="flex-1 min-h-[44px] rounded-lg data-[state=active]:bg-emerald-600 data-[state=active]:text-white data-[state=active]:border-transparent transition-all">
