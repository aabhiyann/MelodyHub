        ...
        <section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 px-4 md:px-0">
                {mixes.map((mix, idx) => (
                    ...
                    >
                        {/* Background Gradient */}
                        <div className={`absolute inset-0 bg-gradient-to-br ${mix.accent} opacity-80 transition-opacity duration-300 group-hover:opacity-100`} />
                        ...
                        <div className="relative h-full p-6 flex flex-col justify-between z-10">
                            <div>
                                ...
                                <p className="text-sm text-white/80 font-medium line-clamp-2">
                                    {mix.songs.map(s => s.artist).slice(0, 3).join(", ")} and more
                                </p>
                            </div>
